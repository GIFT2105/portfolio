...
import { SiPython, SiCsharp, SiReact, SiNextDotJs, SiWordPress, SiLinux, SiPhp, 
...
SiPostgresql, SiMysql,SiWindows, SiGraphql } from 'react-icons/si';
...
{/*Project 3*/}
    ...
    >
      ...
      <img
        ...
        className="w-full h-auto object-cover rounded-t-lg"
      />
      <div className="absolute bottom-0 left-0 w-full p-4 bg-black  text-white">
        <h1 className="text-2xl font-bold"> CareerRoutes-101</h1>
        <p className='flex font-news'>
    ...
    <div className="flip-card-back w-full h-full relative overflow-hidden border-[1px] rounded-lg">
    <img
      src="/im3.jpg" // Replace with the actual path to your image
      alt="Earth Image"
      className="w-full h-auto object-cover rounded-t-lg"
    />
    <h2 className='font-extrabold text-xl font-news  '>Tech Stacks utilised :</h2>
    ...
    <p className='text-center mt-8 font-new text-sm '>
    ...
    <p className='flex flex-row mt-10 font-new  text-sm  mb-4'  >Demo Link: <a href='https://career-routes101.vercel.app/' target='blank' className='text-blue-500 ml-3 '> https://career-routes101.vercel.app/</a></p>
    <p className='flex flex-row mt-10 font-new  text-sm  mb-4'  >Github Link: <a href='https://github.com/GIFT2105/CareerRoutes101' target='blank' className='text-blue-500 ml-3 '>https://github.com/GIFT2105/CareerRoutes101</a></p>
